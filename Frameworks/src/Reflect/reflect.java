...
public class reflect {
    ...
    public static String plAttribute = "";
    public static String plMethod = "";
    public static String plParameter = "";
    static Integer classid = 1;
    static Integer attributeid = 1;
    static Integer methodid = 1;
    static Integer parameterid = 1;
    public static String yumlData = "";
    public static String yumlDataSpecs = "";
    public static String[] fieldFriends;
    /**
     ...
     */
    public static void main(String[] arg, AbsP p) throws ClassNotFoundException, IOException {
        computeYuml = false;
        checkArgs(arg);
        ...
        p.createFile(locationClasses, arg[0]);
    }
